const SEO = [
...

	{
		page: "about",
		description:
			"Ian Kleinfeld, Software Developer, Front End Engineer, Full Stack, UX, UI, with a deep UX, UI, and Design background.",
		keywords: [
			"Front-end developer",
			"UX",
			"UI",
	...
	},
	{
		page: "animations",
		description:
			"Animations done in Adobe Edge Animate for Rally Software to describe and inform about Agile Metrics.",
		keywords: [
			"Agile",
			"Jira",
			"Rally Software",
